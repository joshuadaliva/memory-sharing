...
import { Bell, Lock, LogOut, Settings, UserCheck, UserX } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.settingsContainer}>
        ...
        <TouchableOpacity style={[styles.settingButton, {backgroundColor: '#F43F5E', marginTop: 30}]}>
